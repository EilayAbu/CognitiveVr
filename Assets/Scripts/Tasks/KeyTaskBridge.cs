...
namespace CognitiveVR.Tasks
{
    ...
    /// down with the umbrella, or climbing the stool and grabbing it by hand.
    ...
    ///   key_umbrella_knock    - umbrella hit fast enough, key knocked down.
    ///                           value = hit speed (m/s).
    ///   key_umbrella_too_slow - umbrella touched the zone but too slowly to
    ///                           count. value = hit speed (m/s).
    ...
    ///                           umbrella|hand plus attempt counters.
    ///
    ...
    public class KeyTaskBridge : MonoBehaviour
    {
        ...
        private void RegisterFirstAttempt(string attempt)
        {
        ...
        private void RegisterSolved(string method)
        {
